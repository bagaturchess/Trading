...
public class VarStatistic implements Serializable {
	...
	private double max_val = Double.MIN_VALUE;
	private double min_val = Double.MAX_VALUE;
	...
	public String toString() {
		...
		result += "	" + StringUtils.align(getSTDEV());
		result += "	" + StringUtils.align(getMinVal());
		result += "	" + StringUtils.align(getMaxVal());
